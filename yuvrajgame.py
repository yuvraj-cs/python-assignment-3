...
class Snake:
    def __init__(self):
        ...
        for x, y in self.coordinates:
            circle = canvas.create_rectangle(x, y, x + SPACE_SIZE, y + SPACE_SIZE, fill=SNAKE_COLOR, tag="snake")
...
def next_turn(snake, food):
    ...
    circle = canvas.create_rectangle(x, y, x + SPACE_SIZE, y + SPACE_SIZE, fill=SNAKE_COLOR)
